...
#
# Script generated by Vivado on Sat Nov 01 22:06:14 -0400 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_uart_rx.sh
...
#
# Usage        : tb_uart_rx.sh
#                tb_uart_rx.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_uart_rx.sh [-reset_run]
#                tb_uart_rx.sh [-reset_log]
#                tb_uart_rx.sh [-help]
#
...
#                script (type 'tb_uart_rx.sh -help' for more information).
#
...
# script info
echo -e "tb_uart_rx.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_uart_rx.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../lab6n7.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../lab6n7.gen/sources_1/ip/clk_wiz_0" \
  "../../../../../../../ELEC/ 3500/lab6n7/Work/lab6n7/lab6n7.srcs/sources_1/imports/Work/third_party/baud_gen.sv" \
  "../../../../../../../ELEC/ 3500/lab6n7/Work/lab6n7/lab6n7.srcs/sources_1/imports/Work/src/uart_rx.sv" \
  "../../../../../../../ELEC/ 3500/lab6n7/Work/lab6n7/lab6n7.srcs/sources_1/imports/Work/tb/tb_uart_rx.sv" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tb_uart_rx xil_defaultlib.glbl -o tb_uart_rx_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tb_uart_rx_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tb_uart_rx_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tb_uart_rx_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_uart_rx.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_uart_rx.sh [-help]\n\
Usage: tb_uart_rx.sh [-step]\n\
Usage: tb_uart_rx.sh [-lib_map_path]\n\
Usage: tb_uart_rx.sh [-reset_run]\n\
Usage: tb_uart_rx.sh [-reset_log]\n\
Usage: tb_uart_rx.sh [-keep_index]\n\
Usage: tb_uart_rx.sh [-noclean_files]\n\n\
